...
#Compile
time aoc -board=p520_hpc_m210h_g3x16 -fp-relaxed -DINTEL_CL -report /home/users/u101373/CG-FPGA/opencl/src/FBGABlas_kernels/fblas_kernels_direct.cl -o bin/fpga/fblas_kernels_direct.fpga -reuse-exe=bin/fpga/fblas_kernels_direct.fpga
